...
public class IndexBaseConfigurationRepository implements ConfigurationRepository {
    ...
    public void saveAndUpdateConfigurations(final Client client, final String config, final BytesReference bytesRef,
            ActionListener<IndexResponse> actionListener, long version) {
