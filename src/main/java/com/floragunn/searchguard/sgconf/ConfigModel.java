...
public class ConfigModel {
    ...
    public static class SgRole {
        ...
        public int hashCode() {
            ...
            result = prime * result + ((applicationPerms == null || applicationPerms.isEmpty()) ? 0 : applicationPerms.hashCode());
        ...
        public String toString() {
            return System.lineSeparator() + "  " + name + System.lineSeparator() + "    tenants=" + tenants + System.lineSeparator()
                    + "    ipatterns=" + ipatterns + System.lineSeparator() + "    clusterPerms=" + clusterPerms + System.lineSeparator()
                    + " applicationPerms=" + applicationPerms;
        }
    ...
    public static class Tenant {
        ...
        private boolean checkReadOnly(Set<String> applicationPermissions) {
            for (String permission : applicationPermissions) {
                if (Privileges.SG_TENANT_WRITE.equals(permission)) {
                    return false;
                }
            }
        ...
        @Override
        public String toString() {
            return System.lineSeparator() + "                tenant=" + tenant + System.lineSeparator() + "                applicationPermissions="
