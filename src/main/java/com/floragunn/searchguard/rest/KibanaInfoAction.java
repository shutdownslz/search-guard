		...
		return new RestChannelConsumer() {
			...
			public void accept(RestChannel channel) throws Exception {
				...
				try {
					...
					builder.field("application_permission_migration_required", evaluator.isRbacEnabled()
							&& (applicationPermissionFormatVersion == -1 || applicationPermissionFormatVersion == 1));
